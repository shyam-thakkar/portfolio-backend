...
SECRET_KEY = 'django-insecure-g(6f7gikq$54gdu4!+@dd&7v2pt1b&+(nhj8z$)t8r#gbil7q+'
...
CORS_ALLOWED_ORIGINS = os.getenv(
    ...
    'https://shyam-thakkar.github.io,http://localhost:3000'
).split(',')
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv('DB_NAME', 'portfolio_rag'),
